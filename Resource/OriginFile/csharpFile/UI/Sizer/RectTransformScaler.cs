    ...
    IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    private void Start()
    {
        m_defaultSizeDelta = m_rectTransform.localScale;
    }
    private void Update()
    {
        Active();
    ...
    private void Active()
    {
        if (m_isActive)
        {
            ...
            if (m_hoverTime < m_animationDuration * m_animaitonSpeed)
            {
                ...
                m_rectTransform.localScale = Vector2.Lerp(m_defaultSizeDelta, m_mutiplySizeDelta, curveValue);
            }
            else
            {
        ...
        else
        {
            if (m_hoverTime > 0)
            {
                ...
                m_rectTransform.localScale = Vector2.Lerp(m_mutiplySizeDelta, m_defaultSizeDelta, curveValue);
            }
            else
            {
                m_hoverTime = 0;
